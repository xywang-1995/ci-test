**测试用例**  
DMA_DMATEST_CHANNEL_256_16K_buff_size_2  

**测试概述**  
检测DMA通道的读写功能和性能（DMA通道：dma3chan1，通道宽度：256bit，传输总字节：16K）  
...
**测试方法**  
```
$ ./runltp -P light-evm -f ddt/dma_kernel -s DMA_DMATEST_CHANNEL_256_16K_buff_size_2
```

**实际运行**  
```
$ DMA_DMATEST_CHANNEL_256_16K_buff_size_2 source 'dma3chan1.sh'
dma0chan0.sh：
...
2. 通道申请  
	...
	b) 当前DMA通道：dma3chan1，通道宽度：256bit，传输总字节：16K  
